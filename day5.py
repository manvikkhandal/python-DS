...
#____LOGICAL OPERATOR___


# _AND_ --> this gate return true if both the condition are true
# 0 --> False
# 1 --> True
#   A    B     RESULT
#   0    0       0
...
# _OR_ --> this gate return true if one of the condition is true
# 0 --> False
# 1 --> True
#   A    B     RESULT
#   0    0       0
...
# _NOT_ --> this gate opposites the input if true then false and vice-versa
# 0 --> False
# 1 --> True
#   A    RESULT
#   0      1
