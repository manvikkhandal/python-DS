...
# ________ARITHEMETIC OPERATORS________

# num1=int(input("Enter number 1:"))
# num2=int(input("Enter number 2:"))
# print("num1 + num2: ",num1+num2) # Addition Operator
# print("num1 - num2: ",num1-num2) # Subtraction Operator
# print("num1 * num2: ",num1*num2) # Multiplication Operator
# print("num1 / num2: ",num1/num2) # Division Operator
# print("num1 % num2: ",num1%num2) # Modulus Operator
# print("num1 // num2: ",num1//num2) # Floor Division Operator
# print("num1 ** num2: ",num1**num2) # Power Operator
